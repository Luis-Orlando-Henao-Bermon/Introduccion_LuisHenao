Algoritmo Ejercicio4_Taller_HenaoLuis
	...
	Mientras aprovacion=Verdadero hacer //mientras que la variable aprovacion sea verdadera se repetira el algoritmo
		...
		Escribir "la cantidad en cm3 de agua que necesitas para llenar la piscina es " volumen3 "cm3"
		Escribir "¿Quieres saber la cantidad de agua en cm3 que necesitas para otra piscina? si(1)/no(0)"
		Leer ok 
